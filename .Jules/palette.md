...
## 2026-07-01 - Empty State for CLI Configurations
**Learning:** For a daemon application without explicit arguments, silently failing or only printing a one line error doesn't assist the user.
**Action:** When required configurations are missing or fail to parse, also print the help guide before exiting to provide immediate guidance.
