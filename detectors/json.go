...
func (d *JsonDetector) Detect(line []byte) bool {
	// Fast-path rejection: avoid full json.Unmarshal if field doesn't even exist in the line.
	// This uses bytes.Contains on the raw line, ensuring we match the field as a key.
