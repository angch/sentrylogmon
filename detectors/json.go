...
func (d *JsonDetector) Detect(line []byte) bool {
	// Fast-path rejection: if the line doesn't contain the field name, skip unmarshaling
	...
	// Convert value to string for regex matching. Use type assertion first for performance
	var valStr string
