...
func BenchmarkNginxErrorTimestamp_Regex(b *testing.B) {
	line := []byte(`2023/10/27 10:00:00 [error] 1234#5678: *9012 open() "/var/www/html/nonexistent" failed (2: No such file or directory), client: 127.0.0.1, server: localhost, request: "GET /nonexistent HTTP/1.1", host: "localhost"`)
