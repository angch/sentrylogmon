...
## 2026-02-12 - Optimize Nginx error timestamp parsing
**Learning:** time.Parse overhead can be bypassed using manual byte-scanning when the timestamp structure is rigid.
**Action:** Use existing atoi helpers and time.Date for faster zero-allocation-like parsing logic before doing string conversions.
