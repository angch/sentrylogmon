...
## 2026-03-05 - [Prometheus Metrics for Monitor Lag]
**Learning:** Implemented a new gauge metric in Go and learned to handle absolute vs. relative (dmesg) timestamps by comparing against a heuristic (epoch year 2000). Also, negative lag due to clock skew was ignored to avoid corrupting data.
**Action:** Use this logic when converting unknown timestamps to a consistent timeline in Prometheus.
