...
func SanitizeCommand(args []string) string {
	...
	for i, arg := range args {
		...
		// We only apply heuristics if the argument looks like a flag (starts with "-").
		// This prevents normal arguments (like the word "password") from triggering redaction
		// of the following argument maliciously.
