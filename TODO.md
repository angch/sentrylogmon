...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-17)
  - Implemented `sentrylogmon_monitor_lag_seconds` histogram.
  - Tracks time difference between log timestamp and processing time.
  - Verified with `TestMonitorLagMetric`.
