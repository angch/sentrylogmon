...
- [x] **Prometheus Metrics for Monitor Lag**
  - Added MonitorLagSeconds HistogramVec metric in `metrics/metrics.go`.
  - Calculated time difference between log timestamp and processing time in `monitor/monitor.go`.
  - Added observations to the metric.
