...
- [x] **Prometheus Metrics for Monitor Lag** (2026-03-01)
  - Implemented `sentrylogmon_monitor_lag_seconds` GaugeVec metric to track processing latency.
  - Added absolute and relative timestamp logic leveraging caching of boot time.
  - Wrote comprehensive unit tests to ensure Prometheus metric correctness.
