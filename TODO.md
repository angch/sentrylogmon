...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-23)
  - Added `sentrylogmon_monitor_lag_seconds` histogram.
  - Implemented lag calculation for Unix and uptime-based timestamps (dmesg).
  - Added `TestMonitorLag` to verify metric recording.
