...
- [x] **Prometheus Metrics for Monitor Lag** (2026-03-04)
  - Implemented `sentrylogmon_monitor_lag_seconds` GaugeVec in `metrics`.
  - Updated `Monitor` to calculate and update lag handling both absolute and relative timestamps.
  - Added tests to ensure accurate metric updates.
