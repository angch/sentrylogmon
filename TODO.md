...
- [x] **Prometheus Metrics for Monitor Lag** (2026-03-15)
  - Implemented `sentrylogmon_monitor_lag_seconds` GaugeVec metric to track processing lag.
  - Calculated positive lag (excluding negative values to prevent clock skew corruption).
  - Added unit tests `TestMonitorLagMetrics` to ensure proper metrics increment behavior.
