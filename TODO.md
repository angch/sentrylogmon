...
- [x] **Prometheus Metrics for Monitor Lag** (2026-03-11)
  - Implemented `sentrylogmon_monitor_lag_seconds` gauge in `metrics/metrics.go`.
  - Calculated time difference between processing time and log timestamp.
  - Added protection against negative time skew.
  - Added unit tests for lag calculation and negative lag behavior.
