...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-25)
  - Implemented `MonitorLagSeconds` GaugeVec metric.
  - Added support for absolute (ISO8601/Syslog) and relative (Dmesg) timestamps using system boot time.
  - Added comprehensive unit tests for lag calculation.
