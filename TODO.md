...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-12)
  - Added `ProcessingLagSeconds` to track the lag time in seconds.
  - Updated `monitor.go` to calculate and observe the lag.
