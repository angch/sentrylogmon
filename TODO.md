...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-22)
  - Implemented `sentrylogmon_monitor_lag_seconds` Histogram metric.
  - Added logic to `Monitor.processMatch` to calculate and observe lag.
  - Added unit test `TestMonitorLagMetric` to verify calculation.
