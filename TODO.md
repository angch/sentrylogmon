...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-07)
  - Added `sentrylogmon_monitor_lag_seconds` histogram metric.
  - Implemented lag calculation in `processMatch` for matched lines.
  - Verified with new unit test `TestMonitorLag`.
