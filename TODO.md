...
- [x] **Prometheus Metrics for Monitor Lag** (2026-04-04)
  - Added `MonitorLagSeconds` HistogramVec metric to track time difference between log timestamp and processing time.
  - Implemented lag calculation using sub-second precision to avoid zero lag issues.
