...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-14)
  - Added `sentrylogmon_monitor_lag_seconds` Prometheus histogram.
  - Calculated lag in `processMatch` using manual timestamp extraction.
  - Added unit test `TestMonitorLagMetric` to verify lag calculation.
