...
- [x] **Prometheus Metrics for Monitor Lag** (2026-03-24)
  - Implemented `MonitorLag` histogram to track the difference between log generation time and processing time.
  - Handled absolute timestamps and dmesg relative timestamps using system boot time.
  - Added test case `TestMonitorLagMetric`.
