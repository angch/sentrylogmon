...
- [x] **Prometheus Metrics for Monitor Lag** (2026-03-05)
  - Implemented `MonitorLagSeconds` GaugeVec metric to track processing latency.
  - Added relative vs absolute timestamp support with `host.BootTime`.
  - Ignored negative lag values from clock skew.
  - Added comprehensive unit tests for lag calculation behaviors.
