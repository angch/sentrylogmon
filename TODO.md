...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-13)
  - Implemented `sentrylogmon_monitor_lag_seconds` Prometheus Histogram.
  - Updated `Monitor` to observe lag between log timestamp and processing time.
  - Added unit tests to verify metric recording.
