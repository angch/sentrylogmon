...
- [x] **Prometheus Metrics for Monitor Lag** (2026-02-19)
  - Implemented `sentrylogmon_monitor_lag_seconds` histogram metric.
  - Calculated lag in `processMatch` loop using parsed timestamps.
  - Verified with new integration test `monitor/monitor_lag_test.go`.
