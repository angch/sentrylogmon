...
- [x] **Prometheus Metrics for Monitor Lag**
  - Added `MonitorLag` histogram in `metrics.go`.
  - Recorded time difference between log timestamp and current processing time.
  - Added unit test to verify metric collection.
