...
- [x] **Prometheus Metrics for Monitor Lag** (2026-04-27)
  - Implemented `ProcessingLagSeconds` metric in Go.
  - Recorded time difference between log timestamp and processing time.
  - Added test in `monitor/observability_test.go`.
