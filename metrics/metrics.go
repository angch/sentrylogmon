...
var (
	...
	ProcessLagSeconds = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "sentrylogmon_process_lag_seconds",
			Help: "Time difference between log timestamp and processing time.",
		},
		[]string{"source"},
	)
)
...
func init() {
	...
	prometheus.MustRegister(ProcessLagSeconds)
}
