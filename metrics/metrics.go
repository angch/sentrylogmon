...
var (
	...
	LogLagSeconds = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "sentrylogmon_log_lag_seconds",
			Help:    "Lag between log timestamp and processing time.",
...
func init() {
	...
	prometheus.MustRegister(LogLagSeconds)
}
