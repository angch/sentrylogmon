...
var (
	...
	ProcessingLagSeconds = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "sentrylogmon_processing_lag_seconds",
			Help: "Time difference between log timestamp and processing time in seconds.",
		},
		[]string{"source"},
	)
)
